...
*/
#ifndef MTE_BUILD_RELEASE
#  define MTE_BUILD_RELEASE
#endif
...
#define MTE_PAIRED_LICENSE 0
/* True if the library is built for client usage. */
#define MTE_CLIENT_LICENSE 0
...
#define MTE_DRBG_ENUM mte_drbgs_ctr_aes256_nodf
#define MTE_TOKBYTES 4
#define MTE_VERIFIERS_ENUM mte_verifiers_none
...
#define MTE_SEQUENCING_VERIFIER 0
